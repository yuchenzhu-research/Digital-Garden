...
## 🤖 Agent Pipeline
These rules apply to Claude Code and should stay compatible with OpenAI Codex, Google Antigravity/Gemini-style agents, and other coding agents working in this repository.
