...
*   **美学**：CinzelやEB Garamondのような古典的なタイポグラフィと現代のミニマリズムが出会い、博物館級の読書体験を創出します。
...
1.  **ビジュアルアンカー**：写真をキャンバスに直接ドラッグして背景にします。
2.  **インプレース編集**：ページ上で直接タイプします。タイトル、人物、物語を、実際に表示されるその場所で編集します。
3.  **デュアルモードパーティクル**：Aletスタイルの粒子分解エフェクトを統合し、**Linear** 線形 と **Random** ランダム の2つの視覚モードをサポートします。
...
### 📱 モバイル（iOS / Android）
- **閲覧 + ローカル下書き**: 現在の端末/ブラウザ内でアーカイブを見たり、下書きを残したりできます
...
4.  アクセス：`https://bibliotheca-vitae.vercel.app` または `http://localhost:4321`
