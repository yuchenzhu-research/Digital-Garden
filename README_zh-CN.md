...
* **古典美学**：古典字体 Cinzel 与 EB Garamond 在此同现代极简主义交织，重构博物馆级别的阅读体验。
...
3.  **粒子之变**：集成 Alet-style 粒子系统，支持 **Linear** 线性拉伸与 **Random** 随机碎裂两种解构模式。

## 🛠️ 技术底座 Tech Stack

基于单页应用 SPA 架构，为未来的 Electron 原生化做准备：
...
### 📱 移动端 (iOS / Android)
- **浏览 + 本地草稿**：可查看档案，也可在当前设备/浏览器中记录草稿
