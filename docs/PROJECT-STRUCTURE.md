...
- 根目录保留面向仓库入口的文件：`README*.md`、`CONSTITUTION.md`、`LICENSE`、`package.json`、`next.config.ts`、`tailwind.config.ts`、`tsconfig.json`
...
| 文档层 | `README*.md`, `CONSTITUTION.md`, `LICENSE`, `docs/` | 对外入口文档、项目宪法与内部结构说明 |
